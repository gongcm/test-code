...
int cloning_demo()
{
	...
	if (num == 1)
	{
		string folder = "Normal_Cloning";
		string original_path1 ="Airplane.jpg";
		string original_path2 ="Lena.jpg";
		string original_path3 ="Fruits.jpg";
	...
	{
		string folder = "Monochrome_Transfer";
		string original_path1 ="Airplane.jpg";
		string original_path2 ="Lena.jpg";
		string original_path3 ="Fruits.jpg";
		Mat source = imread(original_path1, IMREAD_COLOR);
	...
	{
		string folder = "Color_Change";
		string original_path1 = "Airplane.jpg";
		string original_path2 ="Fruits.jpg";
		Mat source = imread(original_path1, IMREAD_COLOR);
	...
	{
		string folder = "Illumination_Change";
		string original_path1 ="Airplane.jpg";
		string original_path2 ="Fruits.jpg";
		Mat source = imread(original_path1, IMREAD_COLOR);
		Mat mask = imread(original_path2, IMREAD_COLOR);
	...
	{
		string folder = "Texture_Flattening";
		string original_path1 ="Airplane.jpg";
		string original_path2 ="Fruits.jpg";
		Mat source = imread(original_path1, IMREAD_COLOR);
		Mat mask = imread(original_path2, IMREAD_COLOR);
