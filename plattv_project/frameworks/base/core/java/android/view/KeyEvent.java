...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_HEADSET_IN      = 251;
    public static final int KEYCODE_HEADSET_OUT     = 252;
    public static final int KEYCODE_MIC_ON          = 253;
    public static final int KEYCODE_TOUCH_ZOOMIN    = 254;
    public static final int KEYCODE_TOUCH_ZOOMOUT   = 255;
    public static final int KEYCODE_ICLOUD          = 256;
    public static final int KEYCODE_VOIP            = 257;
    public static final int KEYCODE_GAME_MODE_OPEN  = 258;
    public static final int KEYCODE_GAME_MODE_QUIT  = 259;
    public static final int KEYCODE_GAME_KEY_SET    = 260;
    public static final int KEYCODE_RESET   				= 261; //add
    public static final int KEYCODE_RESOLUTION_RATIO= 1001;
    public static final int KEYCODE_SUB             = 1004;
    public static final int KEYCODE_AUDIO           = 1010;

    public static final int KEYCODE_FAVORITES       = 1177;
    public static final int KEYCODE_IME             = 1178;
    public static final int KEYCODE_SEEK            = 1180;
    public static final int KEYCODE_VOD             = 1182;
    public static final int KEYCODE_NPVR            = 1184;
    public static final int KEYCODE_PQ              = 1185;
		
    private static final int LAST_KEYCODE           = KEYCODE_PQ;
