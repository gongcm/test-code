...
#LOCAL_STATIC_LIBRARIES := libchfp
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../frameworks/base/gpio_control

LOCAL_C_INCLUDES += $(LOCAL_PATH)/../libcommon/

LOCAL_SHARED_LIBRARIES := liblog libcutils libhi_common libhardware libhi_msp libfpanel_ledcontrol
LOCAL_SRC_FILES := hidev.cpp
LOCAL_MODULE := hidev.bigfish
