...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../device/hisilicon/bigfish/sdk/source/msp/api/higo/include
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../device/hisilicon/bigfish/sdk/sample/common/
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../device/hisilicon/bigfish/hidolphin/component/hitranscoder/include/

LOCAL_SHARED_LIBRARIES := libdl libhi_sample_common liblog libhardware libcutils libutils libhi_common libhi_muxer libhi_transcoder libhi_protocol libhi_msp 
LOCAL_SRC_FILES := transcode.cpp

#LOCAL_SRC_FILES += $(sort $(call all-c-files-under,./common))

LOCAL_MODULE := transcode.bigfish
