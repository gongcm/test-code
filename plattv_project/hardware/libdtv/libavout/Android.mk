...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../device/hisilicon/bigfish/sdk/source/msp/api/jpge/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../..//device/hisilicon/bigfish/sdk/source/msp/api/tde/include/

LOCAL_C_INCLUDES += $(LOCAL_PATH)/../libcommon/


LOCAL_SHARED_LIBRARIES := liblog libcutils  libhi_msp libhardware libhi_common
LOCAL_SRC_FILES := avout.cpp convert.cpp
LOCAL_MODULE := avout.bigfish
